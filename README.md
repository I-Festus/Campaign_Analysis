# Campaign Analysis
### This project analyzes marketing campaign data using PostgreSQL. The dataset, provided by HNG Tech, includes details like campaign type, target audience, conversion rate, ROI, clicks, Leveraging SQL-Based Marketing Analytics to Uncover High-Impact Campaign Strategies for Business Growth
